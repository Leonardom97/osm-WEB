...
try {
    ...
    // Configura error mode a excepciones
    ...
    // Función para validar nombres de columna
    ...
    // Verifica existencia de columna en la tabla
    ...
    // Si el registro existe en temporal, intenta aprobar y moverlo a la principal
    if($row){
        $assign = [];
        $vals = [];
        ...
        try {
            ...
            // Borra el registro de la temporal
        ...
        // Si no existe en temporal, intenta actualizar en principal
        $hasCheckMain = $hasCol($pgMain, $table, 'check');
    ...
    // Devuelve error en JSON si ocurre una excepción
