...
try {
    ...
    // Si el registro existe en la base temporal, intenta moverlo a la principal
    if($row){
        $assign = [];
        $vals = [];
        ...
        try {
            // Intenta actualizar el registro en la principal
            ...
            // Elimina el registro de la temporal
