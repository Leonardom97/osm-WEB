...
try {
    ...
    // Decodifica el cuerpo JSON y obtiene el ID
    ...
    // Determina las columnas comunes entre ambas bases
    ...
    // Si el registro existe en temporal, intenta moverlo a la principal
    if($row){
        $assign = [];
        $vals = [];
        ...
        // Fuerza los valores de aprobación
        ...
        try {
            ...
            // Elimina el registro de la base temporal
